...
function HairColorOptions(){
	...
	return <>
		...
		<option value="1">Very Dark Brown</option>
		...
		<option value="6">Medium Blonde</option>
		<option value="7">Light Blonde</option>
	</>
}

function HairLengthOptions(){
        // (0, "short",),
        // (1, "medium",),
        // (2, "long",),
        // (3, "very long",),
	...
	return <>
		...
		<option value="4">Extreme Long</option>
	</>
}

function EyeColorOptions(){
        // (0, "short",),
        // (1, "medium",),
        // (2, "long",),
        // (3, "very long",),
