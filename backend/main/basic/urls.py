...
urlpatterns = [
    ...
    # Detail article
    # path(r'article/<str:country__country_code>/<str:language__country_code>/<int:group_pk>/',
    path(r'<str:category>/<str:country__country_code>/<str:language__country_code>/<int:group_pk>/',
